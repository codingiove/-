    ...
    confirm(e) {
      ...
      uni.uploadFile({
        ...
        success: (uploadFileRes) => {
          ...
          // this.$store.state.img = backstr[0].filename;
          this.$http({
      ...
      return this.list.filter((item) => {
        switch (item.id) {
          case 0:
            ...
            break;
          case 1:
            item.content = myTime.RegistrationDate(this.user.time);
            break;
          case 2:
          ...
          case 3:
            ...
            break;
          case 4:
            this.date = myTime.Time(this.user.birthday) || " ";
            break;
          case 5:
            item.content = this.user.phone || "00000000";
            break;
          case 6:
